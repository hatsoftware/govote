function fm_system(){
  ...
  dtl=dtl+'</div>';
  JBE_OPEN_VIEW(dtl,'Edit System View','close_system');
...
function mnu_system(){
  var jmenu=
    '<div style="width:100%;height:100%;color:'+JBE_TXCLOR1+';">'+
      ...
      '</div>'+      
      '<div id="btn_hd_cancel" onclick="JBE_CLOSE_VIEW()" style="float:left;width:25%;height:100%;margin-left:50%;color:'+JBE_TXCLOR1+';background:none;">'+        
        '<div class="footer_gfxs">'+
