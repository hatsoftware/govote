...
function init_lognow(){
  ...
  document.getElementById('fmsg').innerHTML="zMake sure your password is more than 10 or at least 8 characters."+
...
function chk_lognow(){
  ...
  .catch(function (error) { 
    console.log(error); MSG_SHOW(vbOk,"ERROR:","Log In error: "+error,function(){},function(){});showProgress(false);
  });
}
...
function fm_admin(){
  ...
  var dtl=
    '<div id="div_main_admin" style="width:100%;height:100%;padding:0px;overflow-x:hidden;overflow-y:auto;background:'+JBE_CLOR+';">'+
      ...
      '<div style="height:55px;width:100%;padding:5px;color:'+JBE_TXCLOR1+';background:background:'+JBE_CLOR+';">'+
        '<div style="float:right;height:100%;width:auto;border-radius:50%;border:2px solid white;background:pink;">'+
      ...
      '<div id="div_dtl_admin" style="width:100%;height:'+(H_VIEW-65)+'px;overflow-x:hidden;overflow-y:auto;margin-top:10px;background:white;padding:5px;">'+
        menuMenu+

        '<div style="display:block;width:100%;height:60px;margin-top:10px;padding:5px;border-radius:5px;border:1px solid gray;cursor:pointer;background:none;">'+
          '<div style="float:left;width:auto;height:100%;">'+
            '<img src="../gfx/icon-192x192.png" style="height:100%;"/>'+
          '</div>'+
          '<div style="float:left;width:auto;height:100%;padding:10px 0 0 10px;">'+
            CURR_CLIENTNAME+
          '</div>'+
        '</div>'+

        '<div style="width:100%;height:150px;margin-top:10px;font-size:12px;padding:10px;border:1px solid gray;background:none;">'+
        ...
        '<div style="display:block;width:100%;height:35px;margin-top:5px;padding:5px;cursor:pointer;border-radius:5px;border:1px solid gray;background:none;">'+
...
function save_profile(){
  ...
  .catch(function (error) { console.log(error); 
    showProgress(false);    
    MSG_SHOW(vbOk,"ERROR:","Saving "+error,function(){},function(){});
  });  
}
    ...
    dtl+=
      '<div style="width:100%;height:40px;margin-top:10px;padding:0px;background:none;">'+
        '<div style="float:left;height:100%;width:45px;background:none;">'+          
          '<img src="'+JBE_API+'upload/users/'+aryDB[i]['usercode']+'.jpg?'+n+'" style="float:left;height:100%;width:40px;border-radius:50%;border:2px solid black;background:none;"/>'+
        '</div>'+
...
function callText(){
  ...
  var dtl2=      
    '<div style="width:100%;height:100%;padding:11px 0 0 0;text-align:center;color:'+JBE_TXCLOR1+';background:'+JBE_CLOR+';">'+
      tilt+      
    '</div>';   
